  ...
  return (
    <div className="relative rounded-[2rem] border border-slate-200/70 bg-gradient-to-b from-white to-slate-50/80 p-4 shadow-[0_20px_60px_rgba(15,23,42,0.08)] sm:p-6">
      ...
      {selectedCandidato && (
        <>
          <div 
            className="fixed inset-0 z-[60] bg-slate-950/45 backdrop-blur-sm animate-in fade-in duration-300"
            onClick={() => setSelectedCandidato(null)}
          />
          
          <div className="fixed inset-x-0 bottom-0 z-[70] flex max-h-[90vh] w-full flex-col overflow-hidden rounded-t-[2rem] bg-white shadow-[0_-24px_80px_rgba(15,23,42,0.28)] animate-in slide-in-from-bottom duration-500 sm:bottom-6 sm:right-6 sm:inset-x-auto sm:max-h-[calc(100vh-5.5rem)] sm:w-full sm:max-w-2xl sm:rounded-[2rem] sm:rounded-t-none sm:shadow-[0_24px_80px_rgba(15,23,42,0.22)] sm:animate-in sm:slide-in-from-right sm:top-[64px]">
            <div className="sticky top-0 z-10 flex items-center justify-between border-b border-slate-200 bg-white/95 p-4 backdrop-blur sm:p-6">
              <button 
                onClick={() => setSelectedCandidato(null)}
            ...
            <div className="flex-1 overflow-y-auto p-4 sm:p-8 custom-scrollbar">
              <div className="mb-8 flex flex-col items-center gap-5 rounded-[2rem] border border-slate-200 bg-gradient-to-br from-slate-50 to-white p-5 text-center shadow-sm md:flex-row md:items-start md:gap-8 md:text-left">
              ...
              <div className="flex h-[380px] flex-col rounded-[2rem] border border-slate-200 bg-slate-50 p-4 shadow-inner sm:h-[420px] sm:p-6">
                ...
                <div className="mb-4 flex-1 space-y-4 overflow-y-auto rounded-[1.5rem] border border-dashed border-slate-200 bg-white/80 py-10 pr-2 text-center shadow-sm">
                ...
                <div className="relative mt-auto">
                  <input 
                    ...
                    className="w-full rounded-2xl border border-slate-200 bg-white p-4 pr-14 text-sm font-medium outline-none transition-all placeholder:text-slate-400 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10"
                  />
                  <button className="absolute right-2 top-2 rounded-xl bg-emerald-600 p-2.5 text-white shadow-md transition-all hover:bg-emerald-700">

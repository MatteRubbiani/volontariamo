    ...
    <div className="min-h-screen bg-slate-50 pb-24">
      <div className="bg-white border-b p-6 sticky top-0 z-10 shadow-sm">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <Link href="/app/volontario" className="text-slate-500 font-black flex items-center gap-2 hover:text-blue-600 transition-colors">
            ← TORNA ALLA BACHECA
          </Link>
      ...
      <div className="max-w-4xl mx-auto px-6 mt-10">
        {!candidature || candidature.length === 0 ? (
          <div className="text-center py-20 bg-white rounded-[3rem] shadow-sm border border-slate-100">
            ...
            <Link href="/app/volontario" className="bg-blue-600 text-white px-8 py-4 rounded-2xl font-bold hover:bg-blue-700 transition-all">
              Esplora Annunci
            </Link>
          </div>
        ) : (
